	...
	<section class="main-area">
		<div class="container">
			<div class="card mb-3 card-style-1">
				<div class="card-header card-1-header bg-light">Búsqueda</div>
				<div class="card-body">
...
<option value="6">Casta</option>

<option value="7">Cuatro Cienegas</option>
...
<option value="38">Zaragoza</option>
    ...
    <div class="col-sm">
                            <div class="input-group mb-3">  
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="inputGroupSelect01">Ciclo escolar:</label>
                                </div>
                                <select class="custom-select" id="inputGroupSelect01">
    ...
    <div class="col-sm">
<button type="button" class="btn btn-primary btn-style-1 mr-10">Consultar</button>
    </div>
  </div>					
						</div>
					</div>
			...
			<div class="row justify-content-center flex-column mb-3 ml-0 mr-0">
				<nav>
					<div class="nav nav-tabs nav-tabs-style-1" id="nav-tab" role="tablist">
						<a class="nav-item nav-link nav-link-style-1 active" id="nav-ruta-tab" data-toggle="tab" href="#nav-ruta" role="tab" aria-controls="nav-ruta" aria-selected="true">Índice de Masa Corporal</a>
