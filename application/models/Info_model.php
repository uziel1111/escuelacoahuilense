...
class Info_model extends CI_Model
{
    ...
    function get_info_escuela($id_cct){
      $this->db->select('es.nombre_centro, es.cve_centro, tu.turno, n.nivel, m.modalidad, sos.sostenimiento, re.region, es.domicilio, l.localidad, mun.municipio, es.nombre_director, sta.estatus');
      $this->db->from('escuela es');
      $this->db->join('turno as tu', 'tu.id_turno = es.id_turno');
