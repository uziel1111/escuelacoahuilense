...
class Escuela_model extends CI_Model
{
    ...
    function get_xparams($cve_municipio,$cve_nivel,$cve_sostenimiento,$nombre_escuela){
      $this->db->select('es.cve_centro, tu.turno,es.nombre_centro,ne.nivel_educativo,mu.municipio,lo.localidad,es.domicilio');
      ...
      $this->db->join('turno as tu', 'tu.cve_turno = es.cve_turno');
