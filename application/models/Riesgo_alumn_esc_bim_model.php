...
class Riesgo_alumn_esc_bim_model extends CI_Model
{
    ...
    function get_riesgo_bar_grados_xidct($id_cct,$bimestre,$ciclo, $id_nivel){
      ...
      (SELECT SUM(IF(((IF(extraedad>1,1,0)) + (IF(falta_bim".$bimestre.">7, 2,IF(falta_bim".$bimestre.">3, 1,0))) + (IF(espanol_b".$bimestre."<6 AND espanol_b".$bimestre.">0,1,0)) + (IF(matematicas_b".$bimestre."<6 and matematicas_b".$bimestre.">0,1,0)))>2,1,0)) as muy_alto FROM alumnos_riesgo_{$nivel} WHERE id_cct=".$id_cct." AND ciclo='".$ciclo."' AND grado=3) as muyalto_2,
    ...
    function get_riesgo_bar_grados_xidmuni($id_municipio,$id_nivel,$bimestre,$ciclo){
      ...
      if ($id_municipio>0) {
        ...
        (SELECT SUM(IF(((IF(rie.extraedad>1,1,0)) + (IF(rie.falta_bim".$bimestre.">7, 2,IF(rie.falta_bim".$bimestre.">3, 1,0))) + (IF(rie.espanol_b".$bimestre."<6 AND rie.espanol_b".$bimestre.">0,1,0)) + (IF(rie.matematicas_b".$bimestre."<6 and rie.matematicas_b".$bimestre.">0,1,0)))>2,1,0)) as muy_alto FROM alumnos_riesgo_{$nivel} rie INNER JOIN escuela esc ON rie.id_cct = esc.id_cct WHERE esc.id_nivel=".$id_nivel." AND rie.ciclo='".$ciclo."' AND rie.grado=3) as muyalto_2,
