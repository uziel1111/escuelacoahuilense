...
class Reportepdf_model extends CI_Model
{
    ...
    function get_acciones($id_tprioritario){
      $str_query = "SELECT acc.id_accion, acc.accion, rmca.ambito, acc.accion_f_inicio, acc.accion_f_termino, acc.mat_insumos, CONCAT(IFNULL(av.cte1, '0'), '%') AS avance, acc.ids_responsables, acc.otro_responsable 
