  ...
  <div  class="col-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="row">
        <div class="col-sm-12">
            ...
            <table class="table" id="tabla_estadistica_final">
            	...
            	<tbody  id="contenedor_tablas"></tbody>
            </table>
      			<div class="pie_tabla">
          ...
          <br>
            ...
            <table class="table" id="tabla_estadistica_final2">
              ...
              <tbody  id="contenedor_tablas2"></tbody>
            </table>
      			<div class="pie_tabla">
      			   <div id="fuentes_pie">Fuente: SEP Puebla con base en el Formato 911.</div>
      			</div>
            ...
            <table class="table" id="infraestructura_t1">
            	...
            	<tbody  id="contenedor_tablas3"></tbody>
            </table>
      			<div class="pie_tabla">
      			   <div id="fuentes_pie">Fuente: SEP Puebla con base en el Formato 911.</div>
      			</div>
          ...
          <div id="tb_ind_asis">
              <a name="Indicadores de Asistencia ".$ciclonomb." de Cursos" style="text-decoration:none; color:black;">
                <h3>Indicadores de Asistencia <p id="ind_asist_lb"></p> </h3>
              </a>
          </div>
        		...
        		<table class="table">
        			...
        			<tbody id="contenedor_tablas4"></tbody>
            </table>
            <div class="pie_tabla">
              <div id="fuentes_pie">Fuente: SEP Puebla con base en el Formato 911.</div>
            </div>
          ...
          <div id="tb_ind_perma">
              <a name="Indicadores de Permanencia'.$ciclonomb.' de Cursos" style="text-decoration:none; color:black;">
                <h3>Indicadores de Permanencia <p id="ind_perma_lb"></p></h3>
              </a>
          </div>
            ...
            <table class="table">
            	...
            	<tbody id="contenedor_tablas5"></tbody>
            </table>
      			<div class="pie_tabla">
      			   <div id="fuentes_pie">Fuente: SEP Puebla con base en el Formato 911.</div>
      			</div>
    ...
    <div id="modal_din_retencion" class="modal fade" role="dialog" >
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <span class="modal-title">Retención:</span>
    ...
    <div id="modal_din_aprobacion" class="modal fade">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <span class="modal-title">Aprobación:</span>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
    ...
    <div id="modal_din_et" class="modal fade">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <span class="modal-title">Eficiencia Terminal:</span>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
  ...
  <div id="modal_din_cobertura" class="modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <span class="modal-title">Cobertura:</span>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
  ...
  <div id="modal_din_absorcion" class="modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <span class="modal-title">Absorción:</span>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
  ...
  <div id="modal_din_posicion" class="modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <span class="modal-title">Posición:</span>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
