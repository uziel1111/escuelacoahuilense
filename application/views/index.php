                                        ...
                                        <div class="card main-boxes">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item"><a href="#"><span class="color-1"><i class="material-icons">face</i></span> Resultados por contenido temático (PLANEA) estatal y municipal</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                </div>
                                        ...
                                        <div class="card main-boxes">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group">
                                                  ...
                                                  <li class="list-group-item"><a href="http://www.escuelatransparente.gob.mx/transparencia/2017-2018/lista_utiles_2017-2018.pdf" target="_blank"><span class="color-3"><i class="material-icons">face</i></span> Lista de materiales y útiles</a></li>
                                        ...
                                        <div class="card main-boxes">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group">
                                                  ...
                                                  <li class="list-group-item"><a href="http://bibliotecadigitalcoahuila.gob.mx/" target="_blank"><span class="color-4"><i class="material-icons">face</i></span> Biblioteca digital Coahuila</a></li>
