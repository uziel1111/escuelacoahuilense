                                ...
                                <div class="col-lg-3 col-sm-6">
                                        <div class="card main-boxes">
                                            ...
                                            <div class="card-body">
                                                <!-- List group -->
                                                <ul class="list-group">
                                                    <li class="list-group-item"><a href="#"><span class="color-1"><i class="material-icons">face</i></span> Por estado, municipio y zona</a></li>
                                                    <li class="list-group-item"><a href="#"><span class="color-1"><i class="material-icons">face</i></span> Por escuela</a></li>
                                                    <li class="list-group-item"><a href="#"><span class="color-1"><i class="material-icons">face</i></span> Localiza tu escuela</a></li>
