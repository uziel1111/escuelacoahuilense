...
<h5 class="text-muted">Catálogo Autorizado de Documentos</h5>
							</div>
							<div class="col-auto">
			...
			<div class="card-columns">
				<div class="card card-index shadow mb-4">
					...
					<div class="card-body">
						...
						<p class="card-text text-justify"><a href="#" class="btn btn-secondary btn-lg btn-block">Consultar</a>
						</p>
					</div>
				</div>
				<div class="card card-index shadow mb-4">
					...
					<div class="card-body">
						...
						<p class="card-text text-justify"><a href="simplificaciondemoeb.php" class="btn btn-secondary btn-lg btn-block">Consultar</a>
						</p>
					</div>
				</div>
				<div class="card card-index shadow mb-4">
					...
					<div class="card-body">
						...
						<p class="card-text text-justify"><button type="button" class="btn btn-secondary btn-lg btn-block">Consultar</button>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="card mb-4">
				<div class="card-header">
					<h4 class="mb-0 text-success"><span class="second-txt">Catálogo Autorizado de Documentos por Direcciones de Área</span></h4>
				</div>
				<div class="card-body">
					<div class="accordion accordion-style-1" id="accordionExample">
						<div class="card mb-3">
							<div class="card-header collapsed" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" style="cursor: pointer;">
								<i class="fas fa-clipboard-list mr-2"></i> <span class="second-txt">Dirección de Educación Preescolar Federalizada </span>
							</div>
							<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
								<div class="card-body p-0">
									...
									<ul class="nav nav-tabs nav-justified nav-tabs-style-1" id="myTab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" id="alumno-tab" data-toggle="tab" href="#alumno" role="tab" aria-controls="home" aria-selected="true"><i class="far fa-star text-warning"></i> Top 5</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" id="docente-tab" data-toggle="tab" href="#docente" role="tab" aria-controls="profile" aria-selected="false">Estadística</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" id="director-tab" data-toggle="tab" href="#director" role="tab" aria-controls="contact" aria-selected="false">Contacto</a>
										</li>
									</ul>
												...
												<div class="col">
													<table class="table table-striped table-hover">
														...
														<tbody>
															<tr>
																<th scope="row">1</th>
																<td>Formatos de Alta de Alumnos</td>
																<td>Dirección de Formación Contínua y Profesionalización Docente</td>
																<td>
																	<span data-toggle="modal" data-target="#verDocumento">
		   <button type="button" data-toggle="tooltip" title="Ver documento" class="btn btn-sm btn-secondary"><i class="fas fa-file-alt mx-1"></i></button>
		</span>
																

																	<span data-toggle="modal" data-target="#verDetalle">
		   <button type="button" data-toggle="tooltip" title="Ver detalle" class="btn btn-sm btn-success"><i class="fas far fa-eye"></i></button>
		</span>
		   ...
		   <button type="button" data-toggle="tooltip" title="Ver detalle" class="btn btn-sm btn-success"><i class="fas far fa-eye"></i></button>
												...
												<div class="col-sm-10">
													<div class="box box-especial">
														<div class="box-body no-padding">
															<table class="table">
																<tr>
																	<td style="width: 5%"><i class="fa fa-female"></i>
																	</td>
																	...
																	<td style="width: 10%"><span class="badge bg-red">60%</span>
																	</td>
																</tr>
																<tr>
																	...
																	<td><span class="badge bg-yellow">40%</span>
																	</td>
																</tr>
															</table>
														</div>
											...
											<div class="row">
												<div class="col">
													<div class="wrimagecard wrimagecard-topimage">
														...
														<div class="wrimagecard-topimage_title">
															<h4>Profr. Rafael Balderas Salazar</h4>
														</div>
												...
												<div class="col">
													<p>
														...
														<ul class="fa-ul">
															<li class="text-muted"><span class="fa-li"><i class="far fa-building"></i></span>Director de Educación Pimaria Federalizada </li>
															...
															<li><span class="fa-li text-danger"><i class="fas fa-phone"></i></span>(844) 411 89 71 Ext. 3650</li>
															<li><span class="fa-li text-danger"><i class="fas fa-envelope"></i></span><a href="http://www.sec.gob.mx/" target="_blank">rafael_281973@hotmail.com </a>
															</li>
														</ul>
													</p>
												</div>
						...
						<div class="card mb-3">
							<div class="card-header collapsed" id="heading2" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2" style="cursor: pointer;">
								<i class="fas fa-clipboard-list mr-2"></i> <span class="second-txt"> Dirección de Educación Pimaria Federalizada</span>
							</div>
													...
													<table class="table table-striped table-hover">
														...
														<tbody>
															<tr>
																...
																<td>Formatos de Alta de Alumnos</td>
																<td>Dirección de Formación Contínua y Profesionalización Docente</td>
																<td><a href="#" class="btn btn-secondary btn-sm" role="button" aria-pressed="true" data-toggle="tooltip" data-placement="top" title="Ver documento"><i class="fas fa-file-alt mx-1"></i></a>
																	<a href="#" class="btn btn-success btn-sm" role="button" aria-pressed="true" data-toggle="tooltip" data-placement="top" title="Ver detalle"><i class="far fa-eye"></i></a>
																</td>
															</tr>
															<tr>
																<th scope="row">2</th>
		   ...
		   <button type="button" data-toggle="tooltip" title="Ver detalle" class="btn btn-sm btn-success"><i class="fas far fa-eye"></i></button>
															...
															<tr>
																...
																<td>Formatos de Alta de Alumnos</td>
																<td>Control Escolar</td>
																<td><a href="#" class="btn btn-secondary btn-sm" role="button" aria-pressed="true"><i class="far fa-eye"></i></a>
																</td>
															</tr>
															<tr>
																<th scope="row">4</th>
											...
											<div class="row">
												<div class="col">
													<div class="wrimagecard wrimagecard-topimage">
														...
														<div class="wrimagecard-topimage_title">
															<h4>Mtro. Jesús Alonso Campos</h4>
														</div>
												...
												<div class="col">
													<p>
														...
														<ul class="fa-ul">
															<li class="text-muted"><span class="fa-li"><i class="far fa-building"></i></span>Dirección de Formación Contínua y Profesionalización Docente</li>
															<li><span class="fa-li text-danger"><i class="fas fa-map-marker-alt"></i></span>Coordinación General de Educación Normal y Actualización Docente</li>
															<li><span class="fa-li text-danger"><i class="fas fa-phone"></i></span>(844) 411 88 00 Ext. 3149</li>
															<li><span class="fa-li text-danger"><i class="fas fa-envelope"></i></span><a href="http://www.sec.gob.mx/" target="_blank">dfcyed@seducoahuila.gob.mx</a>
															</li>
						...
						<div class="card mb-3">
							<div class="card-header collapsed" id="heading3" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3" style="cursor: pointer;">
								<i class="fas fa-clipboard-list mr-2"></i> <span class="second-txt"> Dirección de Educación Secundaria General</span>
							</div>
...
<a class="btn btn-success mb-2" href="#" role="button"><i class="fas fa-file-download"></i> Descargar</a>   
	  </div>
  </div>
  <div class="row">
    <div class="col-sm">
<img src="assets/img/formatoejemplo.jpg" class="img-fluid" alt="Responsive image">
	  </div>
  </div>					
			</div>
			</div>
...
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Nombre: <span class="fw800">Formatos de Alta de Alumnos</span>
</div>		 
    </div>
  </div>
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Descripción: <span class="fw800">Documento obligatorio para darlo de alta en SIECEC.</span>
</div>		
...
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Área que lo solicita a la escuela: <span class="fw800">Supervisión, Jefatura de sector.</span>
</div>		   
    </div>
  </div>					
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Destino final: <span class="fw800">Planeación.</span>
</div>		   
    </div>
  </div>
...
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Forma de generar el requerimiento: <span class="fw800">En un sistema automatizado.</span>
</div>		   
    </div>
  </div>
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Nivel educativo: <span class="fw800">Primaria.</span>
</div>		   
    </div>
  </div>					
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Forma de entrega: <span class="fw800">Captura de sistema.</span>
</div>		   
    </div>
  </div>
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Requiere oficio para entregar: <span class="fw800">Si.</span>
</div>		   
    </div>
  </div>
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Periodicidad: <span class="fw800">Bimestral.</span>
</div>		   
    </div>
  </div>
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Fecha de entrega: <span class="fw800">Enero, Marzo, Mayo, Julio, Octubre, Diciembre.</span>
</div>		   
    </div>
  </div>	
<div class="row">
    <div class="col-sm">
<div class="alert alert-success my-1 py-1 fz-18" role="alert">
  Fundamento legal: <span class="fw800">Ninguno.</span>
</div>		   
    </div>
  </div>
